...
- 📊 Setting up **observability stacks** — Prometheus, Grafana, Datadog, ELK, Victoria Metrics
...
- GCP (primary — GKE, VPC, Cloud Load Balancing, Cloud DNS, Cloud Storage, IAM, WIF, Cloud Logging/Monitoring, Cloud Run, Cloud Armor)
...
- Terraform (modular IaC — reusable modules for GCP/AWS)
